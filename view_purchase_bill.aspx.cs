...
public partial class view_purchase_bill : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(orderNo))
            {
                ...
                string query = "SELECT [order_no], [date], [vendor_name], [Total_amt] FROM [purchase_order_details] WHERE order_no = @order_no";
    ...
    protected void back_P_Click(object sender, EventArgs e)
    {
