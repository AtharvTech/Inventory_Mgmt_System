<%@ Page Title="" Language="C#" MasterPageFile="~/in_master.master" AutoEventWireup="true" CodeFile="view_purchase_bill.aspx.cs" Inherits="view_purchase_bill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container-fluid d-flex justify-content-center border align-items-center">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT order_id, prod_name, HSN, quantity, unit_price, gst_rate, size, total, gst_price FROM purchase_product_details WHERE (order_id LIKE '%' + @order_id + '%')">
            <SelectParameters>
    ...
    <asp:Label ID="pass_bill" runat="server" class="d-none" Text=""></asp:Label>
